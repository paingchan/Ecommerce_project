...
<?php require_once'inc/nav_select.php' ?>
      ...
      <div class="col-xs-12 col-sm-12 col-md-9 rht-col"> 
        ...
        <div id="category" class="category-carousel hidden-xs">
          <div class="item">
            <div class="image"> <img src="admin/img/marazzo_website/<?php echo $row['search_img'] ?>" alt="" class="img-responsive"> </div>
            <div class="container-fluid">
              <div class="caption vertical-top text-left">
                <div class="big-text"><?php echo $row['se_text_1'] ?></div>
                <div class="excerpt hidden-sm hidden-md"><?php echo $row['se_text_2'] ?></div>
                <div class="excerpt-normal hidden-sm hidden-md"><?php echo $row['se_text_3'] ?></div>
...
$ret=mysqli_query($con,"select * from products where tag like '$find'");
                    ...
                    <div class="item">
                        ...
                        <!-- /.product-info -->
                                <div class="product-info text-left">
                                    <h3 class="name"><a href="detail.php?id=<?php echo $row['id'] ?>"><?php echo htmlentities($row['name']);?></a></h3>
