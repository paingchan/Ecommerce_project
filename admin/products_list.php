...
if(isset($_GET['page']))
    ...
    $query = "select * from products order by id desc limit $start_from,$num_per_page  ";
                        ...
                        <div class="card ecommerce-card">
                            ...
                            <div class="card-body">
                                ...
                                <h6 class="item-name">
                                    ...
                                    <span class="card-text item-company">By <a href="javascript:void(0)" class="company-name"><?php echo $row['code']; ?></a></span>
                                </h6>
                            ...
                            <div class="col-sm-12">
                                <nav aria-label="Page navigation example">
                                    ...
                                    <?php 
                                        ...
                                        if($page>1)
                                        {
                                            echo "<li class='page-item prev-item'><a href='products_list.php?page=".($page-1)."' class='page-link'>Previous</a></li>";
                                        }
                        
                                        
                                        for($i=1;$i<$total_page;$i++)
                                        {
                                            echo "<li class='page-item'><a href='products_list.php?page=".$i."' class='page-link'>$i</a></li>";
                                        }
                        
                                        if($i>$page)
                                        {
                                            echo "<li class='page-item next-item'><a href='products_list.php?page=".($page+1)."' class='page-link'>Next</a></li>";
                                        }
                        ...
                        <div class="card">
                                ...
                                while($row = mysqli_fetch_assoc($category))
                            {
                                ...
                                ?>
                                            ...
                                            <button type="button" class="btn btn-flat-primary"><a href="products_category_list.php?id=<?php echo $row['cat_id'] ?>"><?php echo $row['cat_name']; ?></a></button>
                                            </div>
                                        </li>
                                ...
                                while($row = mysqli_fetch_array($brand))
                            {
                                ...
                                <div id="product-categories">
                                    <h6 class="filter-title">Warehouse</h6>
                                    <ul class="list-unstyled categories-list">
                                        <li>
                                        <?php
                                ...
                                while($row = mysqli_fetch_assoc($warehouse))
                            {
                                ...
                                ?>
                                            ...
                                            <button type="button" class="btn btn-flat-primary"><a href="products_warehouse_list.php?id=<?php echo $row['id'] ?>"><?php echo $row['warehouse']; ?></a></button>
                                            </div>
                                        </li>
                                ...
                                <div id="product-categories">
                                    <h6 class="filter-title">Suppliers</h6>
                                    <ul class="list-unstyled categories-list">
                                        <li>
                                            ...
                                            <button type="button" class="btn btn-flat-primary"><a href="products_suppliers_list.php">Suppliers</a></button>
                                            </div>
                                        </li>
