...
<?php
		...
		if (isset($_GET['id']))
		{
			$warehouse_id =mysqli_real_escape_string($con,$_GET['id']);
		}
		
		$particular_product = get_warehouse_product($warehouse_id);
		$display_warehouse_link = display_warehouse_link($warehouse_id);
		$result = mysqli_fetch_assoc($display_warehouse_link);
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><?php echo $result['warehouse'] ?>
                                    </li>
                                </ol>
                            </div>
                        </div>
