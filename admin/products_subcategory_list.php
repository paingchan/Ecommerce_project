                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><?php echo $result['sub_name'] ?>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="card">
                                ...
                                while($row = mysqli_fetch_assoc($subcategory))
                            {
                                ...
                                <div id="clear-filters">
                                    <button type="button" class="btn btn-block btn-dark"><a href="products_category_list.php">Back</a></button>
                                </div>
