...
<?php
		...
		if (isset($_GET['id']))
		{
			$suppliers_id =mysqli_real_escape_string($con,$_GET['id']);
		}
		
		$particular_product = get_suppliers_product($suppliers_id);
		$display_suppliers_link = display_suppliers_link($suppliers_id);
		$result = mysqli_fetch_assoc($display_suppliers_link);
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><?php echo $result['sup_name']  ?>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="card">
                                ...
                                while($row = mysqli_fetch_assoc($suppliers))
                            {
                                ...
                                ?>
                                            ...
                                            <button type="button" class="btn btn-flat-primary"><a href="products_suppliers_list.php?id=<?php echo $row['sup_id'] ?>"><?php echo $row['sup_name']; ?></a></button>
                                            </div>
